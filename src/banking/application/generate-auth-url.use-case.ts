...
import { BANKING_PROVIDER, type GenerateAuthUrlDTO, type IBankingProvider } from "../domain/IBanking-provider.interface";
import { env } from "src/config/env";

@Injectable()
export default class AddBankAccountUseCase {
	constructor(
		@Inject(BANKING_PROVIDER) private readonly bankingProvider: IBankingProvider
	) {}
